                  ...
                  >
                        ...
                        <Image
                          ...
                          style={{
                            filter: isActive 
                              ...
                              : "brightness(0) saturate(100%) invert(27%) sepia(51%) saturate(1234%) hue-rotate(181deg) brightness(95%) contrast(89%)",
                          }}
                        />
                      </div>
                      <span
                    ...
                    <ChevronDown
                      className={`h-4 w-4 transition-transform ${
                        otherSourcesExpanded ? "rotate-180" : ""
                    ...
                    <div className="bg-white relative">
                      {otherSourcesSubItems.map((subItem, subIndex) => (
                        <div key={subItem.id} className="relative">
                          <button
                            className={`w-full text-left pl-14 px-4 py-2 transition-colors ${
